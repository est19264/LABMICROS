...
void __attribute__((picinterrupt(("")))) isr(void){
    if(T0IF == 1){
        PORTEbits.RE2 = 0;
        PORTEbits.RE0 = 1;
        PORTD = (tabla7seg[centena]);
        multiplex = 0b00000001;

        if (multiplex == 0b00000001){
            PORTEbits.RE0 = 0;
            PORTEbits.RE1 = 1;
            PORTD = (tabla7seg[decena]);
            multiplex = 0b00000010;
        }
        if (multiplex == 0b00000010){
            PORTEbits.RE1 = 0;
            PORTEbits.RE2 = 1;
            PORTD = (tabla7seg[unidad]);
            multiplex = 0b00000000;
        }
        INTCONbits.T0IF = 0;
        TMR0 = 255;
    }
