...
;
;Programa: Contador con alarma
;Hardware: Push Buttons en puerto A y leds en puerto B, c y D
;
;Creado: 16 feb, 2021
...
; Se limpian los puertos
 ...
 bcf ((OPTION_REG) and 07Fh), 3 ; Prescaler para timer0
 bsf ((OPTION_REG) and 07Fh), 2
 bsf ((OPTION_REG) and 07Fh), 1
 bcf ((OPTION_REG) and 07Fh), 0 ; PS = 110
 BANKSEL PORTA
 call reiniciar_timer0
 return
